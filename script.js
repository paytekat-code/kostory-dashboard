...
function hitungLamaTinggal(masuk, keluar) {
  ...
  const y = Math.floor(diff / 365), m = Math.floor((diff % 365) / 30), h = diff % 30;
...
// SHARE SELURUH DATA (LENGKAP BANGET)
